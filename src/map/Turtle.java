...
public class Turtle extends JFrame {
    ...
    public static void create(int width, int height) {
        ...
        if (turtle == null) {
            ...
            turtle.setSize(new Dimension(width + insets.left + insets.right, height + insets.top + insets.bottom));
            ...
            throw new RuntimeException("Error: attempted to call Turtle.create twice");
    }
    ...
    public static void spot(double d) {
        if (d <= 1)
            offscreen.drawRect((int) x, (int) y, 1, 1);
    ...
    public static void spot(String s, double w, double h) {
        ...
        offscreen.rotate(Math.toRadians(orientation), x, height - y);
        offscreen.drawImage(image, (int) (x - w / 2.0), (int) (height - y - h / 2.0), (int) w, (int) h, null);
        offscreen.rotate(Math.toRadians(-orientation), x, height - y);
    }
